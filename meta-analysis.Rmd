...
Here we see that this yields d = 2.10 with var.d = .10, equal to sd.d = 0.32. This would yield a much, much more significant result. Perhaps the authors have confused standard deviation for standard error. Let's talk about how to fix that.
